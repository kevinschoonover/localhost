    ...
    packages.myNiri = inputs.wrapper-modules.wrappers.niri.wrap {
      ...
      settings = {
        spawn-at-startup = [
          ...
          (lib.getExe pkgs-unstable.kitty)
          ["spotify" "--enable-features=UseOzonePlatform" "--ozone-platform=wayland"]
          (lib.getExe pkgs-unstable.google-chrome)
          ["discord" "--use-gl=desktop" "--enable-features=UseOzonePlatform" "--ozone-platform=wayland"]
        ...
        workspaces = {
          "1:code" = { open-on-output = "DP-8"; };
          "2:term" = { open-on-output = "DP-8"; };
          "3" = { open-on-output = "DP-8"; };
          "4" = { open-on-output = "DP-8"; };
          "5" = { open-on-output = "DP-8"; };
          "6" = { open-on-output = "DP-8"; };
          "7:music" = { open-on-output = "eDP-1"; };
          "8:misc" = { open-on-output = "eDP-1"; };
          "9:web" = { open-on-output = "DP-8"; };
          "10:chat" = { open-on-output = "eDP-1"; };
        };
        ...
        window-rules = [
          ...
          }
          {
            ...
            open-on-workspace = "9:web";
          }
          {
            matches = [{ app-id = "discord"; }];
            open-on-workspace = "10:chat";
          }
          {
        ...
        binds = {
          ...
          "Mod+8".focus-workspace = "8:misc";
          "Mod+9".focus-workspace = "9:web";
          "Mod+0".focus-workspace = "10:chat";
          ...
          "Mod+Shift+8".move-column-to-workspace = "8:misc";
          "Mod+Shift+9".move-column-to-workspace = "9:web";
          "Mod+Shift+0".move-column-to-workspace = "10:chat";
